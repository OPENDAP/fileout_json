...
#ifndef FoJsonDouble_h_
#define FoJsonDouble_h_ 1
 ...
 */
class FoJsonDouble : public FoJsonBaseType
{
private:
    Float64 *			_f ;
public:
    				FoJsonDouble( BaseType *b ) ;
    virtual			~FoJsonDouble() ;
