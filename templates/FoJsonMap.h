 ...
 * by the different FoJsonGrid instances.
 */
class FoJsonMap : public BESObj
{
private:
    FoJsonArray *			_arr ;
    bool			_ingrid ;
    ...
    bool			_defined ;
    int				_ref ;
    				FoJsonMap() : _arr( 0 ), _ingrid( false ),
					    _defined( false ), _ref( 1 ) {}
public:
    				FoJsonMap( FoJsonArray *a, bool ingrid = false ) ;
    virtual			~FoJsonMap() ;
