 ...
 */
void
FoJsonAttributes::add_attributes( int ncid, int varid, BaseType *b )
{
    string emb_name ;
    BaseType *parent = b->get_parent() ;
    if( parent )
    {
	FoJsonAttributes::add_attributes( ncid, varid, parent, emb_name ) ;
    }
 ...
 */
void
FoJsonAttributes::addattrs( int ncid, int varid, BaseType *b,
 ...
 */
void
FoJsonAttributes::addattrs( int ncid, int varid, AttrTable &attrs,
 ...
 */
void
FoJsonAttributes::addattrs( int ncid, int varid, const string &var_name,
			  AttrTable &attrs,
			  ...
			  const string &prepend_attr )
{
    ...
    new_name = FoJsonUtils::id2netcdf( new_name ) ;
    if( varid == NC_GLOBAL )
 ...
 */
void
FoJsonAttributes::add_original_name( int ncid, int varid,
				   const string &var_name,
				   const string &orig )
{
    if( var_name != orig )
