...
#ifndef FoJsonStructure_h_
#define FoJsonStructure_h_ 1
 ...
 * BaseTypes as FoJsonBaseType instances.
 */
class FoJsonStructure : public FoJsonBaseType
{
private:
    Structure *			_s ;
    vector<FoJsonBaseType *>	_vars ;
public:
    				FoJsonStructure( BaseType *b ) ;
    virtual			~FoJsonStructure() ;
